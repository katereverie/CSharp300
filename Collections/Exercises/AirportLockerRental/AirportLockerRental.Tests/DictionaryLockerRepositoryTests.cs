...
namespace AirportLockerRental.Tests
{
    ...
    {
        public DictionaryLockerRepository? _repo;
        ...
        {
            DictionaryLockerRepository repo = new DictionaryLockerRepository(1);

            var result1 = repo.AddContents(new LockerContents
            {
                LockerNumber = 1,
                Description = "test",
                RenterName = "owner"
            ...
            var result2 = repo.AddContents(new LockerContents
            {
                LockerNumber = 2,
                Description = "test",
                RenterName = "owner"
